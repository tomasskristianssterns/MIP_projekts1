...
class GameGUI:
    ...
    def create_selection_screen(self):
        ...
        # Jauna izvēle - kurš sāk spēli
        self.starting_player_label = ttk.Label(self.selection_frame, text="Kurš sāk spēli?")
        self.starting_player_label.grid(row=3, column=0, padx=5, pady=5)

        self.starting_player_option = ttk.Combobox(self.selection_frame, values=["Spēlētājs", "AI"])
        self.starting_player_option.grid(row=3, column=1, padx=5, pady=5)
        self.starting_player_option.set("Spēlētājs")
    ...
    def start_game_from_selection(self):
        ...
        player_starts = self.starting_player_option.get() == "Spēlētājs"
        
        self.set_algorithm(algorithm)
        self.selection_frame.destroy()
        self.start_game(number, player_starts)
